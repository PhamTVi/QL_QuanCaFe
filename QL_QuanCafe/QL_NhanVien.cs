    ...
    public partial class QL_NhanVien : Form
    {
        ...
        private void dgv_NhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                txt_NgaySinh.Text = DateTime.Parse(dgv_NhanVien.CurrentRow.Cells[2].Value.ToString()).ToString("dd/MM/yyyy");
                ...
                txt_NgayVL.Text = DateTime.Parse(dgv_NhanVien.CurrentRow.Cells[6].Value.ToString()).ToString("dd/MM/yyyy");
        ...
        private void cms_Suanv_Click(object sender, EventArgs e)
        {
            ...
            string ngaysinh = DateTime.Parse(dgv_NhanVien.CurrentRow.Cells[2].Value.ToString()).ToString("dd/MM/yyyy");
